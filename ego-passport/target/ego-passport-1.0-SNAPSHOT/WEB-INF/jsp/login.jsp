...
<form id="formlogin" method="post" onsubmit="return false;">
    <div class=" w1" id="entry">
            ...
            <div class="form ">
                ...
                <div class="item fore2">
                    ...
                    <div class="item-ifo">
                        ...
                        <input type="password" id="nloginpwd" name="pwd" class="text" tabindex="2" autocomplete="off" onblur="mdjia()"/>
        ...
        <div class="free-regist">
            <span><a href="/user/showRegister?interurl=${interurl}" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<script type="text/javascript">
